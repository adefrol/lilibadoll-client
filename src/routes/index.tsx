                    ...
                    <div className="flex gap-10 items-center justify-around px-10 py-4 ">
                        <div className="w-[500px]">
                            <p className="text-xl">
                                ...
                                материал. Используемая акриловая краска для 3D
                                моделей: обладает яркими цветами и безопасностью
                                для детей.
                            </p>
                        </div>
                        <div className="w-[180px]">
                            <img src={`${API_URL}/about-image-1.png`} alt="" />
                        </div>
                        <div className="w-[180px]">
                            <img src={`${API_URL}/about-image-2.png`} alt="" />
                        </div>
                    </div>
                    <div className="flex gap-10 items-center justify-around px-10 py-4 ">
                        <div className="w-[500px]">
                        ...
                        <div className="w-[180px]">
                            <img src={`${API_URL}/about-image-3.png`} alt="" />
                        </div>
                        <div className="w-[180px]">
                            <img src={`${API_URL}/about-image-4.png`} alt="" />
                        </div>
                    </div>
                    <div className="flex gap-10 items-center justify-around px-10 py-4 ">
                        <div className="w-[500px]">
                            <p className="text-xl">
                                Вы имеете возможность создать уникальный дизайн
                                для игрушек и капсул по своему вкусу и
                                предпочтениям.
                            </p>
                        </div>
                        <div className="w-[180px]">
                            <img src={`${API_URL}/about-image-5.png`} alt="" />
                        </div>
                        <div className="w-[180px]">
                            <img src={`${API_URL}/about-image-6.png`} alt="" />
                        </div>
                    </div>
                </div>
            </div>
